  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'var(--neon-cyan)10', borderBottom: '1px solid var(--terminal-border)' }}
      >
        ...
        {SLOTS.map(({ key, label }) => {
          ...
          return (
            <div
              ...
              style={{ borderColor: 'var(--neon-cyan)08' }}
            >
              <span className="flex-shrink-0 text-sm w-5 text-center">{emoji}</span>
              <span className="w-20 flex-shrink-0" style={{ color: 'var(--neon-cyan)70' }}>
                {label}:
              </span>
